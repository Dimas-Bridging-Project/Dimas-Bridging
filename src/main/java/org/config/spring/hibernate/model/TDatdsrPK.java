 ...
 */
@Embeddable
public class TDatdsrPK implements Serializable {
    ...
    public int hashCode() {
        int hash = 7;
        hash = 71 * hash + Objects.hashCode(this.transNo);
        hash = 71 * hash + Objects.hashCode(this.itemCode);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final TDatdsrPK other = (TDatdsrPK) obj;
