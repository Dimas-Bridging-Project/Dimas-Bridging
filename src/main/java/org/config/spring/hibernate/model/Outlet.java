...
//    @JoinColumn(name = "outlet", referencedColumnName = "scy_out_code", insertable = false, updatable = false)
...
//    }
     ...
     */
    @ManyToOne(optional = true)
    @JoinColumn(name = "outlet", referencedColumnName = "scy_customer_id", insertable = false, updatable = false)
