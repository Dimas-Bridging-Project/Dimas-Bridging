...
//    @JoinColumn(name = "salesman", referencedColumnName = "sales_id_scy", insertable = false, updatable = false)
...
//    }
     ...
     */
    @ManyToOne(optional = true)
    @JoinColumn(name = "salesman", referencedColumnName = "scy_employee_id", insertable = false, updatable = false)
